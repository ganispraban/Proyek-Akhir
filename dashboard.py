...
# Dataset paths
hour_dataset = "C:/Users/ASUS/Downloads/Proyek Akhir/Bike-sharing-dataset/hour.csv"
day_dataset = "C:/Users/ASUS/Downloads/Proyek Akhir/Bike-sharing-dataset/day.csv"
...
sns.barplot(x='hr', y='cnt', hue='season', data=data, ci=None)
...
plt.figure(figsize=(12, 6))
sns.barplot(x='weekday_name', y='cnt', hue='season', data=data, ci=None)
...
sns.barplot(x='season', y='cnt', data=avg_bike_usage_per_season, palette="coolwarm", ci=None)
...
plt.figure(figsize=(12, 6))
sns.barplot(x='hr', y='cnt', hue='weather_label', data=data, ci=None)
...
plt.figure(figsize=(10, 6))
sns.barplot(x='weather_label', y='cnt', data=avg_bike_usage_per_weather, palette='viridis', ci=None, dodge=True)
